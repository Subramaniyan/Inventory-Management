						...
						<div class="row">
							<div class="col-lg-12">
								<form id="login-form" action="LoginServlet" method="post" style="display: block;">
									...
									<div class="form-group">
										<input type="password" id="password" name="userpass" tabindex="2" class="form-control" placeholder="Password">
									</div>
								...
								<form id="register-form" action="RegisterServlet" method="post" style="display: none;">
									...
									<div class="form-group">
										<input type="email" name="usermail" id="email" tabindex="1" class="form-control" placeholder="Email Address" value="">
									</div>
									<div class="form-group">
